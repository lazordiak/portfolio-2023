    ...
    <div>
      ...
      <div className="p-24 flex justify-center">
        <main className="px-48 w-full text-snow flex flex-col">
          <span className="lg:text-6xl font-bold">Wherever You Go</span>
          ...
          <div className="mt-48 flex-col flex lg:text-lg">
            ...
            <span className="mt-12">
              ...
              expression used as a lament, a recognition that, try as we might,
              we are unable to change ourselves or escape from &quot;who we
          ...
          {/*
          When Lizzy gets back to me I can put the pics here
          ...
          <div className="mt-48 flex-col flex lg:text-lg">
            ...
            <span className="mt-12">
              ...
              rather than their absolute position in the world. The program
              reads the current orientation of the controller and, when the
              player moves forward, adjusts the landscape accordingly. This
              ensures that each person’s journey, and where each person ends up,
              are unique to them. The project is built in Unreal Engine and
              works with most major VR headset; Facebook&apos;s Oculus,
          ...
          <div className="mt-48 flex-col flex">
            ...
            <span className="mt-12 lg:text-lg">
              ...
              other projects, it takes objective data (movement of the player)
              and attempts to tell a story with it. The twist here is that the
              story ends when the player wants it to end -- they have to find
              the culmination of the work in themselves. In the future I plan to
